...
using SkyFaith.Module.BusinessObjects.DC;

namespace SkyFaith.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class SkyFaithModule : ModuleBase {
        public SkyFaithModule() {
            InitializeComponent();
        ...
        public override void Setup(XafApplication application) {
            ...
            //XafTypesInfo.Instance.RegisterEntity("Custome", typeof(ICustomer));
