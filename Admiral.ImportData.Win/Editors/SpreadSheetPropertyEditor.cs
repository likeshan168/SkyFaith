...
namespace Admiral.ImportData.Win.Editors
{
    ...
    public class SpreadSheetPropertyEditor : PropertyEditor, IComplexControl, IComplexViewItem
    {
        public SpreadSheetPropertyEditor(Type objectType, IModelMemberViewItem viewItem) : base(objectType, viewItem)
        {
        ...
        public ExcelImporter Importer
        {
            get; private set;
        }
        protected override object CreateControlCore()
        {
            var spread = new SpreadsheetControl();
            this.View.ControlsCreated += View_ControlsCreated;
            Importer.InitializeExcelSheet(spread.Document,this.option);
            return spread;
        }
        ...
        private void View_ControlsCreated(object sender, EventArgs e)
        {
            ...
            //var t = new SpreadSheetRibbonCreator(this.Control as SpreadsheetControl, ribbon);
        }
    ...
    public class SpreadSheetRibbonCreator
    {

        ExcelImporter ExcelImporter;
        public SpreadSheetRibbonCreator(SpreadsheetControl spread,RibbonControl ribbon,ExcelImporter ei,Form parent)
        {
            if (ribbon != null)
            {
                this.ribbonControl1 = ribbon;
            }
            else
            {
                this.ribbonControl1 = new RibbonControl();
                this.ribbonControl1.Name = "ribbonControl1";
                ribbon = this.ribbonControl1;
                ribbon.Dock = DockStyle.Top;
                parent.Controls.Add(ribbonControl1);
            ...
            InitializeComponent();
            var p = this.ribbonControl1.Pages.GetPageByName("fileRibbonPage1").Groups[0];

            if (!p.ItemLinks.Any(x => x.Caption == "确定导入"))
            {
        ...
        {
            if (e.Item.Name == "ImportExcelData")
            {
                ExcelImporter.ProcessImportAction(this.SpreadSheet.Document);
            }
        }

        private void InitializeComponent()
        {
            DevExpress.XtraBars.Ribbon.ReduceOperation reduceOperation1 = new ReduceOperation();
            DevExpress.XtraBars.Ribbon.GalleryItemGroup galleryItemGroup1 = new GalleryItemGroup();
            ...
            // SpreadSheet
            // 
            this.SpreadSheet.MenuManager = this.ribbonControl1;
            ...
            this.ribbonControl1.Size = new System.Drawing.Size(1221, 182);
            // 
            ...
            this.spreadsheetBarController1.Control = this.SpreadSheet;
            // 
            ...
            this.commandBarGalleryDropDown14.Gallery.RowCount = 2;
            ...
            this.commandBarGalleryDropDown16.Gallery.RowCount = 7;
            ...
            this.commandBarGalleryDropDown17.Gallery.RowCount = 11;
            ...
            this.commandBarGalleryDropDown18.Gallery.RowCount = 9;
            ...
            this.commandBarGalleryDropDown19.Gallery.RowCount = 9;
        ...
        public DevExpress.XtraSpreadsheet.SpreadsheetControl SpreadSheet;
    }
}
