...
namespace MVVMDemo.Views.tb_SFI_TrackNumCollectionView
{
    public partial class tb_SFI_TrackNumCollectionView : XtraUserControl
    {
        public tb_SFI_TrackNumCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            ...
            var fluentAPI = mvvmContext.OfType<MVVMDemo.ViewModels.tb_SFI_TrackNumCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as MVVMDemo.tb_SFI_TrackNum,
