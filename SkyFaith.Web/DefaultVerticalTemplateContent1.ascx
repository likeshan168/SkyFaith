<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContent1.ascx.cs" ClassName="DefaultVerticalTemplateContent1" Inherits="SkyFaith.Web.DefaultVerticalTemplateContent1" %>
                            ...
                            <tr>
                                <td class="Logo">
                                    <asp:HyperLink runat="server" NavigateUrl="#" ID="LogoLink">
                                        <cc4:ThemedImageControl ID="TIC" DefaultThemeImageLocation="Images" ImageName="Logo64x64.png"
                                ...
                                <div id="LP" class="LeftPane">
                                    <cc3:XafUpdatePanel ID="UPNC" runat="server" UpdatePanelForASPxGridListCallback="False">
                                        <cc2:NavigationActionContainer ID="NC" runat="server" CssClass="xafNavigationBarActionContainer"
                                            ContainerId="ViewsNavigation" Width="100%" />
                                    </cc3:XafUpdatePanel>
